...
public class AddMembersTableViewController: UITableViewController, TypedRowControllerType {
    ...
    public override func viewDidDisappear(animated: Bool) {
        myFriendshipsRef?.removeObserverWithHandle(friendshipAddedHandle!)
        myFriendshipsRef?.removeObserverWithHandle(friendshipChangedHandle!)
        myFriendshipsRef?.removeObserverWithHandle(friendshipRemovedHandle!)
    }
    ...
    public override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        selectedBackgroundView.backgroundColor = Color.primary.colorWithAlphaComponent(0.03)
