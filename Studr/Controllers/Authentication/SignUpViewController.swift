...
class SignUpViewController : UIViewController{
    ...
    override func viewDidLoad() {
        ...
        firstNameField.tintColor = Color.primary
        lastNameField.tintColor = Color.primary
        emailField.tintColor = Color.primary
        usernameField.tintColor = Color.primary
        passwordField.tintColor = Color.primary
        signUpBtn.backgroundColor = Color.primary
